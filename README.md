...
```bash
#海外
bash <(curl -Lsk https://raw.githubusercontent.com/linke131/ccaa/master/ccaa.sh)
#国内
bash <(curl -Lsk https://raw.githubusercontent.com/linke131/ccaa/master/ccaa.sh) cdn
```
